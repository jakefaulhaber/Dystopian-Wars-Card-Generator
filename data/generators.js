window.generators = {
	...
	'Mirage Generator':
		'Unless at Point Blank, this model is Obscured to Gunnery attacks. As a SpecOp Action, may be placed anywhere within 7", gain a level of disorder, in same facing.',
	'Portal Generator (1)':
	    'Start of Operations, may place 1 40mm Portal Tokens within 10" of Model. Each extra Model in Unit adds placing distance by 5" to max of 20"',
	'Portal Generator (2)':
	    'Start of Operations, may place 2 40mm Portal Tokens within 10" of Model. Each extra Model in Unit adds placing distance by 5" to max of 20"',
